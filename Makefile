postgres:
	docker run --name postgres --network bank-network -p 5432:5432 -e POSTGRES_USER=root -e POSTGRES_PASSWORD=root -d postgres
...
mock:
	mockgen -package mockdb  -destination db/mock/store.go  github.com/iqthuc/simple_bank/db/sqlc Store
